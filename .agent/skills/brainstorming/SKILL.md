...
- Write clearly and concisely — follow the `clean-code` skill conventions
...
When brainstorming involves visual decisions (mockups, layout comparisons, wireframes), use the `frontend-design` skill for design principles and the `browser-test` skill to verify UI implementations.
