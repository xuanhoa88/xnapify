...
# Use branch naming from /git-commit: type/short-description
...
**Called by:**
- **brainstorming** skill (after design approved, before implementation)
- **writing-plans** skill (before plan execution)
- Any skill needing isolated workspace

**Pairs with:**
- `/git-commit` workflow — Conventional Commits when work is complete
...
**Branch naming:** Follow `/git-commit` conventions: `feat/`, `fix/`, `refactor/`, `docs/`
