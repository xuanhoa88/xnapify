...
def get_soffice_bin() -> str:
    ...
    if system == "Windows":
        paths = ["soffice.exe", r"C:\Program Files\LibreOffice\program\soffice.exe", r"C:\Program Files (x86)\LibreOffice\program\soffice.exe"]
    elif system == "Darwin":
...
def _needs_shim() -> bool:
    ...
    if platform.system() == "Windows":
        return False
    try:
        s = socket.socket(getattr(socket, "AF_UNIX", 1), socket.SOCK_STREAM)
        s.close()
        return False
