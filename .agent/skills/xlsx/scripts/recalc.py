...
def setup_libreoffice_macro():
    ...
    if system == "Darwin":
        macro_dir = MACRO_DIR_MACOS
    elif system == "Windows":
        macro_dir = MACRO_DIR_WINDOWS
    else:
        macro_dir = MACRO_DIR_LINUX
...
def recalc(filename, timeout=30):
    ...
    try:
        # Use python's timeout as a safety net for cross-platform support
        result = subprocess.run(cmd, capture_output=True, text=True, env=get_soffice_env(), timeout=timeout + 5)
