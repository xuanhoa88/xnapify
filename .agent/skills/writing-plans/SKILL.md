...
> **For agentic workers:** Implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking. Use the `using-git-worktrees` skill for workspace isolation and the `test-driven-development` skill for each task.
