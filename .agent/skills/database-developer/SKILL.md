...
| Need | Skill / Workflow |
|------|-----------------|
| Module lifecycle (migrations hook) | `module-developer` skill |
| Extension lifecycle | `extension-developer` skill |
| Engine architecture | `engine-developer` skill |
| Adding data to a module | `/add-data` workflow |
| Security (SQL injection) | `security-auditor` skill |
