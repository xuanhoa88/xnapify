...
| Need | Skill / Workflow |
|------|-----------------|
| Consuming engines from modules | `module-developer` skill |
| Consuming engines from extensions | `extension-developer` skill |
| Adding a new engine | `/add-engine` workflow |
| Coding standards | `clean-code` skill |
| Testing patterns | `test-driven-development` skill |
| Security requirements | `security-auditor` skill |
