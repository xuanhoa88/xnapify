...
_Define any core schema alterations needed for this module._
...
_Define the native expressive routes this module will support._
...
_Define the React views and data fetching lifecycle._
...
_Define required user-facing terminology._
...
_Define any services this module registers on the DI container for cross-module use._
...
_Define any worker functions or queue-based handlers for processing._
...
_Note: Once this file is filled out, use it as a reference for the AI to generate or review code against._
