  ...
  externals: [
    ...
    nodeExternals({
      allowlist: [
        ...
        reImage, // Images must be bundled (need asset modules for URLs)
        reFont, // Fonts must be bundled (need asset modules for URLs)
        // Allow all local file imports (relative paths)
        // This ensures local images, fonts, and other assets are bundled
        moduleName => /^\.\.?\//.test(moduleName), // Matches './' or '../'
      ],
    }),
  ],
