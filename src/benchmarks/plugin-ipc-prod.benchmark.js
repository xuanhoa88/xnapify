// Production-grade plugin IPC stress benchmark
...
// Create express app and route that proxies to a fresh PluginRegistry instance
...
describe('plugin-ipc-prod', () => {
  ...
  beforeAll(done => {
    registry = new PluginRegistryClass();
