...
function ScrollToTop() {
  ...
  return (
    <Button
      ...
      className={clsx(
        'fixed bottom-(--space-6) right-(--space-6) z-50 rounded-full w-12 h-12 p-0 flex items-center justify-center transition-[opacity,transform] duration-300 ease-in-out shadow-(--shadow-4) cursor-pointer',
        showScroll
