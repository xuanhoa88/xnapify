...
This folder (`src/apps/plugins/`) is a **Core Module**. 
...
Unlike Plugins, Core Modules are fully woven into the backend architecture.
...
2. **Schema Control**: You are allowed to create and export original Sequelize models in `api/models/`. You do not need to use Plugin Hooks to alter the DB.
