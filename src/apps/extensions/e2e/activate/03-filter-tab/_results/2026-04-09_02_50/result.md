...
5. ❌ Verify the badge count on the "Active" tab includes this extension — Text "badge count for Active tab" not visible on page
...
Text "badge count for Active tab" not visible on page
