...
3. ❌ Find an inactive extension card (toggle switch is unchecked) — Waiting for selector `[class*='switch'], [class*='toggle'], label[class*='switch']` failed: Waiting failed: 15000ms exceeded
...
Waiting for selector `[class*='switch'], [class*='toggle'], label[class*='switch']` failed: Waiting failed: 15000ms exceeded
