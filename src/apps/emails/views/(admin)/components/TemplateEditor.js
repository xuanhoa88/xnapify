...
@media (prefers-color-scheme: dark) {
  :root {
    --tt-color-text:        #f3f4f6;
    --tt-color-muted:       #9ca3af;
    --tt-color-border:      #374151;
    --tt-color-border-light:#374151;
    --tt-color-bg:          #111827;
    --tt-color-bg-subtle:   #1f2937;
    --tt-color-bg-code:     #1f2937;
    --tt-color-bg-pre:      #0f172a;
    --tt-color-link:        #60a5fa;
    --tt-color-link-hover:  #93c5fd;
    --tt-editor-bg:         #111827;
    --tt-editor-border:     1px solid #374151;
    --tt-selection-bg:      rgba(96,165,250,0.2);
    --tt-cell-selected-bg:  rgba(96,165,250,0.1);
  }

  .ProseMirror mark            { background-color: #713f12; color: #fef08a; }
  .ProseMirror code            { color: #f87171; }
  .ProseMirror table th        { background-color: #1f2937; }
  .ProseMirror span[data-type="mention"] {
