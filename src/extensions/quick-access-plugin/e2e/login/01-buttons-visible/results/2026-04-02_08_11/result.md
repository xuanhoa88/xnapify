...
2. ✅ Wait for the page to fully loadwait: Wait for all resources to finish loading
3. ✅ Verify the quick access login buttons are visible below the login formassert_visible: Check Admin User demo button is visible
4. ✅ Verify there are demo account buttons rendered by the extension slotassert_visible: Check Jane Smith demo button is visible
