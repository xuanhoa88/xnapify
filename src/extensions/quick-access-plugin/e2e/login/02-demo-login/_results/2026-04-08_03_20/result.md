...
2. ✅ Click the "Admin User" quick access demo account button — click: Click the Admin User demo button
3. ✅ Wait 3000 milliseconds for automatic form submission — wait: Wait 3000ms for login flow
4. ✅ Assert the text "System Administrator" is visible on the page — assert_visible: Verify user is logged in as System Administrator
