...
4. ❌ Verify the posts list or empty state is visible — Text "posts list or empty state" not visible on page
...
Text "posts list or empty state" not visible on page
